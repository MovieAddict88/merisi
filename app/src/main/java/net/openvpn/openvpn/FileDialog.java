...
public class FileDialog extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (file.isDirectory()) {
            ...
            new Builder(this).setIcon(R.drawable.file_dialog_icon).setTitle("[" + file.getName() + "] " + getText(R.string.file_dialog_cant_read_folder)).setPositiveButton("OK", new DialogInterface.OnClickListener() {
