...
public abstract class OpenVPNClientBase extends AppCompatActivity implements EventReceiver {
    ...
    protected void createConnectShortcut(String profile_name, String shortcut_name) {
        getApplicationContext().sendBroadcast(new Intent().setAction("com.android.launcher.action.INSTALL_SHORTCUT").putExtra("android.intent.extra.shortcut.INTENT", new Intent(this, OpenVPNClient.class).addFlags(8388608).putExtra("net.openvpn.openvpn.AUTOSTART_PROFILE_NAME", profile_name)).putExtra("android.intent.extra.shortcut.NAME", shortcut_name).putExtra("android.intent.extra.shortcut.ICON_RESOURCE", ShortcutIconResource.fromContext(getApplicationContext(), R.drawable.openvpn_connected)));
    }

    protected void createDisconnectShortcut(String shortcut_name) {
        getApplicationContext().sendBroadcast(new Intent().setAction("com.android.launcher.action.INSTALL_SHORTCUT").putExtra("android.intent.extra.shortcut.INTENT", new Intent(this, OpenVPNDisconnect.class).addFlags(8388608)).putExtra("android.intent.extra.shortcut.NAME", shortcut_name).putExtra("android.intent.extra.shortcut.ICON_RESOURCE", ShortcutIconResource.fromContext(getApplicationContext(), R.drawable.openvpn_disconnected)));
    }
    ...
    protected void init_default_preferences(PrefUtil prefs) {
        ...
        if (!prefs.contains_key("force_aes_cbc_ciphersuites")) {
            prefs.set_boolean("force_aes_cbc_ciphersuites", true);
        }
