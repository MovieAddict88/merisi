...
public class OpenVPNService extends VpnService implements Callback, net.openvpn.openvpn.OpenVPNClientThread.EventReceiver {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "openvpn_service_channel";
    private static final long STATUS_CHECK_INTERVAL_MS = 30000;
    ...
    private long last_bytes_in = 0;
    private long last_bytes_out = 0;
    private Bitmap chartBitmap;
    private Bitmap flagIconBitmap;
    ...
    public static class Challenge {
        ...
        public String toString() {
            ...
            objArr[OpenVPNService.EV_PRIO_INVISIBLE] = this.challenge;
    ...
    private class ConnectivityReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.SCREEN_ON".equals(act)) {
                ...
                objArr[OpenVPNService.EV_PRIO_INVISIBLE] = Boolean.valueOf(pvbs);
                ...
                objArr[OpenVPNService.EV_PRIO_INVISIBLE] = Boolean.valueOf(this.conn_on);
                ...
                str = OpenVPNService.TAG;
                objArr = new Object[OpenVPNService.MSG_EVENT];
                objArr[OpenVPNService.EV_PRIO_INVISIBLE] = intent.toString();
    ...
    private static class DynamicChallenge {
        ...
        public String toString() {
            Object[] objArr = new Object[OpenVPNService.EV_PRIO_HIGH];
            objArr[OpenVPNService.EV_PRIO_INVISIBLE] = this.challenge.toString();
    ...
    public static class EventMsg {
        ...
        public int flags = OpenVPNService.EV_PRIO_INVISIBLE;
        public int icon_res_id = -1;
        public String info;
        public String name;
        public int priority = F_ERROR;
        public String profile_override;
        public int progress = OpenVPNService.EV_PRIO_INVISIBLE;
        public int res_id = -1;
        ...
        public String toString() {
            ...
            objArr[OpenVPNService.EV_PRIO_INVISIBLE] = this.name;
            buffer.append(String.format("EVENT: %s", objArr));
            if (this.info.length() > 0) {
                objArr = new Object[F_ERROR];
                objArr[OpenVPNService.EV_PRIO_INVISIBLE] = this.info;
                buffer.append(String.format(" info='%s'", objArr));
            }
            if (this.transition != Transition.NO_CHANGE) {
                objArr = new Object[F_ERROR];
                objArr[OpenVPNService.EV_PRIO_INVISIBLE] = this.transition;
    ...
    public class Profile {
        ...
        public String get_profile_type() {
            return this.profile_type != null ? this.profile_type : "Premium";
        }
        ...
        private Profile(String location_arg, String filename, boolean filename_is_url_encoded_profile_name, ClientAPI_EvalConfig ec) {
            ...
            int n2 = (int) sev.size();
            for (int i = OpenVPNService.EV_PRIO_INVISIBLE; i < n2; i += OpenVPNService.MSG_EVENT) {
        ...
        public String get_filename() {
            if (this.location != null && (this.location.equals("bundled") || this.location.equals("imported"))) {
    ...
    private static class ProfileFN {
        ...
        public static String strip_ovpn_ext(String fn) {
            ...
            return fn.substring(OpenVPNService.EV_PRIO_INVISIBLE, fn.length() - 5);
        }
    ...
    public class ProfileList extends ArrayList<Profile> {
        ...
        private void load_profiles(String location, String password) throws IOException {
            ...
            if (location.equals("imported")) {
                ...
                String[] fnlist = OpenVPNService.this.fileList();
                filename_is_url_encoded_profile_name = true;
                String[] arr$ = fnlist;
                int len$ = arr$.length;
                for (int i$ = OpenVPNService.EV_PRIO_INVISIBLE; i$ < len$; i$ += OpenVPNService.MSG_EVENT) {
                    String fn = arr$[i$];
                    if (ProfileFN.has_ovpn_ext(fn)) {
                        try {
                            ...
                            if (ec.getError()) {
                                str = OpenVPNService.TAG;
                                objArr = new Object[OpenVPNService.MSG_LOG];
                                objArr[OpenVPNService.EV_PRIO_INVISIBLE] = fn;
        ...
        public String[] profile_names() {
            ...
            for (int i = OpenVPNService.EV_PRIO_INVISIBLE; i < size(); i += OpenVPNService.MSG_EVENT) {
        ...
        private void invalidate_epki_alias(String epki_alias) {
            Iterator i$ = iterator();
            while (i$.hasNext()) {
                ((Profile) i$.next()).invalidate_epki_alias(epki_alias);
            }
        }
        ...
        public void new_connection(Intent connect_intent, String profile_name, String proxy_name, String username, String password, boolean allow_creds_dialog, ProxyList proxy_list, boolean proxy_retry) {
            if (!proxy_retry) {
                ...
                if (p != null) {
                    ...
                    this.n_retries = OpenVPNService.EV_PRIO_INVISIBLE;
    ...
    public static class ServerEntry {
        ...
        public String toString() {
            ...
            objArr[OpenVPNService.EV_PRIO_INVISIBLE] = this.server;
    ...
    public static class ServerList {
        ...
        public String toString() {
            ...
            while (i$.hasNext()) {
                buffer.append(((ServerEntry) i$.next()).toString() + ",");
            }
            return buffer.toString();
        }
    }
    ...
    private class TunBuilder extends VpnService.Builder implements net.openvpn.openvpn.OpenVPNClientThread.TunBuilder {
        ...
        public boolean tun_builder_set_remote_address(String address, boolean ipv6) {
            try {
                ...
                Object[] objArr = new Object[OpenVPNService.MSG_LOG];
                objArr[OpenVPNService.EV_PRIO_INVISIBLE] = address;
        ...
        public boolean tun_builder_reroute_gw(boolean ipv4, boolean ipv6, long flags) {
            try {
                String str = OpenVPNService.TAG;
                Object[] objArr = new Object[OpenVPNService.EV_PRIO_HIGH];
                objArr[OpenVPNService.EV_PRIO_INVISIBLE] = Boolean.valueOf(ipv4);
                objArr[OpenVPNService.MSG_EVENT] = Boolean.valueOf(ipv6);
                objArr[OpenVPNService.MSG_LOG] = Long.valueOf(flags);
                Log.d(str, String.format("BUILDER: reroute_gw ipv4=%b ipv6=%b flags=%d", objArr));
                if (ipv4) {
                    addRoute("0.0.0.0", OpenVPNService.EV_PRIO_INVISIBLE);
                }
                if (!ipv6) {
                    return true;
                }
                addRoute("::", OpenVPNService.EV_PRIO_INVISIBLE);
                return true;
            } catch (Exception e) {
        ...
        public boolean tun_builder_add_search_domain(String domain) {
            try {
                ...
                objArr[OpenVPNService.EV_PRIO_INVISIBLE] = domain;
        ...
        public boolean tun_builder_set_mtu(int mtu) {
            try {
                String str = OpenVPNService.TAG;
                Object[] objArr = new Object[OpenVPNService.MSG_EVENT];
                objArr[OpenVPNService.EV_PRIO_INVISIBLE] = Integer.valueOf(mtu);
        ...
        public boolean tun_builder_set_session_name(String name) {
            try {
                String str = OpenVPNService.TAG;
                Object[] objArr = new Object[OpenVPNService.MSG_EVENT];
                objArr[OpenVPNService.EV_PRIO_INVISIBLE] = name;
        ...
        public int tun_builder_establish() {
            try {
                ...
                PendingIntent pi = OpenVPNService.this.get_configure_intent();
                if (pi != null) {
        ...
        public void tun_builder_teardown() {
            try {
                Log.d(OpenVPNService.TAG, String.format("BUILDER: teardown", new Object[OpenVPNService.EV_PRIO_INVISIBLE]));
            } catch (Exception e) {
        ...
        private void log_error(String meth_name, Exception e) {
            String str = OpenVPNService.TAG;
            Object[] objArr = new Object[OpenVPNService.MSG_LOG];
            objArr[OpenVPNService.EV_PRIO_INVISIBLE] = meth_name;
    ...
    private class FetchProfilesTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String login_code = params[1];
                String promo_id = params.length > 2 ? params[2] : "";
                ...
                String postData = "login_code=" + URLEncoder.encode(login_code, "UTF-8");
                if (!promo_id.isEmpty()) {
                    postData += "&promo_id=" + URLEncoder.encode(promo_id, "UTF-8");
                }
                ...
                try {
                    ...
                    if (jsonObj.getString("status").equals("success")) {
                        ...
                        for (int i = 0; i < profiles.length(); i++) {
                            ...
                            int profile_id = p.getInt("id");
                            String profile_name = p.getString("profile_name");
                            String profile_content = p.getString("profile_content");
                            String profile_type = p.optString("profile_type", "Premium");
                            String icon_path = p.optString("icon_path", null);
                            ...
                            if (!ec.getError()) {
                                Profile prof = new Profile("imported", profileFilename, true, ec);
                                prof.id = profile_id;
    ...
    public void onCreate() {
                ...
                new Thread(new Runnable() {
						...
						public void run() {
							...
							if (login_code != null) {
								...
								long delta_in = stats.bytes_in - last_bytes_in;
								long delta_out = stats.bytes_out - last_bytes_out;

								if (delta_in > 0 || delta_out > 0) {
									String response = HttpsClient.checkStatus(BASE_URL, login_code, delta_in, delta_out, "active", session_id);
									if ("disconnect".equals(response)) {
										mHandler.post(new Runnable() {
												@Override
												public void run() {
													stop_thread();
													Intent disconnectIntent = new Intent("net.openvpn.openvpn.ACTION_DISCONNECT_UI");
													sendBroadcast(disconnectIntent);
												}
											});
									}
									last_bytes_in = stats.bytes_in;
									last_bytes_out = stats.bytes_out;
								}

								final ConnectionStats finalStats = stats;
								mHandler.post(new Runnable() {
										@Override
										public void run() {
											if (mNotifyBuilder != null) {
												long total_bytes = finalStats.bytes_in + finalStats.bytes_out;
												String data_usage = humanReadableByteCount(total_bytes, true);
												mNotifyBuilder.setSubText("Data usage: " + data_usage);
												chartBitmap = ChartGenerator.generateChartBitmap(OpenVPNService.this, finalStats.bytes_in, finalStats.bytes_out);
												if (chartBitmap != null) {
													mNotifyBuilder.setStyle(new Notification.BigPictureStyle().bigPicture(chartBitmap));
												}
        ...
        if (nm != null) {
            NotificationChannel channel = new NotificationChannel(
				...
				"OpenVPN connection",
				NotificationManager.IMPORTANCE_LOW // no sound, low importance
            );
            channel.setDescription("OpenVPN foreground service status");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            String str = TAG;
            Object[] objArr = new Object[MSG_EVENT];
            objArr[EV_PRIO_INVISIBLE] = action;
    ...
    private boolean rename_profile_action(String prefix, Intent intent) {
        ...
        File dir = getFilesDir();
        Object[] objArr = new Object[MSG_LOG];
        objArr[EV_PRIO_INVISIBLE] = dir.getPath();
        ...
        if (FileUtil.renameFile(from_path, to_path)) {
            ...
            this.pwds.remove("auth", profile_name);
            this.pwds.remove("pk", profile_name);
            gen_event(EV_PRIO_INVISIBLE, "PROFILE_RENAME_SUCCESS", new_profile.get_name(), new_profile.get_name());
            return true;
        }
        String str = TAG;
        Object[] objArr2 = new Object[MSG_LOG];
        objArr2[EV_PRIO_INVISIBLE] = from_path;
    ...
    private boolean do_connect_action(String prefix, Intent intent, boolean proxy_retry) {
        ...
        try {
            ...
            String str = TAG;
            Object[] objArr = new Object[MSG_EVENT];
            objArr[EV_PRIO_INVISIBLE] = Integer.valueOf(profile_content.length());
            Log.d(str, String.format("SERV: profile file len=%d", objArr));
            return start_connection(profile, profile_content, gui_version, proxy_context, server, proto, conn_timeout, username, password, cache_password, pk_password, response, epki_alias, compression_mode);
        } catch (IOException e) {
            Object[] objArr2 = new Object[MSG_LOG];
            objArr2[EV_PRIO_INVISIBLE] = location;
    ...
    private boolean start_connection(Profile profile, String profile_content, String gui_version, ProxyContext proxy_context, String server, String proto, String conn_timeout, String username, String password, boolean cache_password, String pk_password, String response, String epki_alias, String compression_mode) {
        if (this.active) {
            return false;
        }
        ...
        config.setForceAesCbcCiphersuites(this.prefs.get_boolean("force_aes_cbc_ciphersuites", false));
        if (gui_version != null) {
        ...
        String str = TAG;
        String str2 = "SERV: CONNECT prof=%s user=%s proxy=%s serv=%s proto=%s to=%s resp=%s epki_alias=%s comp=%s";
        Object[] objArr = new Object[9];
        objArr[EV_PRIO_INVISIBLE] = profile.name;
        objArr[MSG_EVENT] = username;
        objArr[MSG_LOG] = proxy_context != null ? proxy_context.name() : "undef";
        objArr[EV_PRIO_HIGH] = server;
        objArr[4] = proto;
        objArr[5] = conn_timeout;
        objArr[6] = response;
        objArr[7] = epki_alias;
        objArr[8] = compression_mode;
        Log.i(str, String.format(str2, objArr));
        this.current_profile = profile;
        set_autostart_profile_name(profile.get_name());
        start_notification();
        gen_event(EV_PRIO_INVISIBLE, "CORE_THREAD_ACTIVE", null);
        thread.connect(this);
        this.mThread = thread;
        ...
        SharedPreferences login_prefs = getSharedPreferences(LoginActivity.PREFS_NAME, MODE_PRIVATE);
        String login_code = login_prefs.getString("login_code", null);
        String device_id = login_prefs.getString("device_id", null);
        String params = "login_code=" + login_code + "&device_id=" + device_id + "&profile_id=" + profile.get_id();
        new ApiLoginTask().execute(BASE_URL + "api.php", params);

        return true;
    }

    private String getCountryCode(String profileName) {
        if (profileName == null || profileName.isEmpty()) {
            return null;
        }

        // Example logic: vpnbook-ca123 -> ca
        ...
        // Another example: sg-server -> sg
        String[] parts = profileName.split("-");
        if (parts.length > 1 && parts[0].length() == 2) {
            return parts[0];
        }

        // Fallback for names like 'us...'
        if (profileName.length() >= 2) {
            String potentialCode = profileName.substring(0, 2);
    ...
    private void start_notification() {
        if (this.mNotifyBuilder == null && this.current_profile != null) {
			...
			PendingIntent disconnectPendingIntent = PendingIntent.getService(this, 0, disconnectIntent, PendingIntent.FLAG_IMMUTABLE);

            this.mNotifyBuilder = builder
				.setContentIntent(get_configure_intent())
				...
				.addAction(R.drawable.disconnected, resString(R.string.disconnect), disconnectPendingIntent);

            String countryCode = getCountryCode(this.current_profile.get_name());
            if (countryCode != null) {
                String imageUrl = BuildConfig.FLAG_URL + countryCode.toLowerCase() + ".png";
                ...
                Glide.with(this)
					...
					.into(new CustomTarget<Bitmap>() {
						...
						public void onResourceReady(Bitmap resource, Transition<? super Bitmap> transition) {
							flagIconBitmap = resource;
							mNotifyBuilder.setLargeIcon(flagIconBitmap);
							startForeground(NOTIFICATION_ID, mNotifyBuilder.build());
						}
            ...
            if (chartBitmap != null) {
                this.mNotifyBuilder.setStyle(new Notification.BigPictureStyle().bigPicture(chartBitmap));
            }
    ...
    private void update_notification_event(EventMsg evm) {
        if (this.mNotifyBuilder != null && evm.priority >= MSG_EVENT) {
            if (evm.icon_res_id == R.drawable.connected) {
                this.mNotifyBuilder.setSmallIcon(R.drawable.openvpn_connected);
            } else if (evm.icon_res_id == R.drawable.connecting) {
                this.mNotifyBuilder.setSmallIcon(R.drawable.openvpn_connecting);
            } else if (evm.icon_res_id == R.drawable.error) {
			...
			if (flagIconBitmap != null) {
                this.mNotifyBuilder.setLargeIcon(flagIconBitmap);
            }
            startForeground(NOTIFICATION_ID, this.mNotifyBuilder.build());
    ...
    public IBinder onBind(Intent intent) {
        if (intent == null || !intent.getAction().equals(ACTION_BIND)) {
            String str = TAG;
            Object[] objArr = new Object[MSG_EVENT];
            objArr[EV_PRIO_INVISIBLE] = intent;
    ...
    public void client_attach(EventReceiver evr) {
        ...
        String str = TAG;
        Object[] objArr = new Object[MSG_EVENT];
        objArr[EV_PRIO_INVISIBLE] = Integer.valueOf(this.clients.size());
    ...
    public void refresh_profile_list(Integer promo_id) {
        ...
        String login_code = login_prefs.getString("login_code", null);
        if (login_code != null) {
            new FetchProfilesTask().execute(BASE_URL + "api_get_profiles.php", login_code, promo_id != null ? String.valueOf(promo_id) : "");
        } else {
    ...
    public Profile get_current_profile() {
        ...
        if (pl.size() >= MSG_EVENT) {
            return (Profile) pl.get(EV_PRIO_INVISIBLE);
        }
        return null;
    }
    ...
    public void gen_ui_reset_event(boolean exclude_self, EventReceiver cli) {
        int flags = EV_PRIO_INVISIBLE;
        if (exclude_self) {
            flags = EV_PRIO_INVISIBLE | 16;
        }
        gen_event(flags, "UI_RESET", null, null, cli);
    }

    public void gen_proxy_context_expired_event() {
        gen_event(EV_PRIO_INVISIBLE, "PROXY_CONTEXT_EXPIRED", null);
    }
    ...
    public ConnectionStats get_connection_stats() {
        ...
        if (this.active && this.mThread != null) {
            ...
            if (cs.duration < 0) {
                cs.duration = EV_PRIO_INVISIBLE;
            }
            cs.bytes_in = tun_stats.getBytesIn();
            cs.bytes_out = tun_stats.getBytesOut();
            int lpr_bms = transport_stats.getLastPacketReceived();
            if (lpr_bms >= 0) {
    ...
    private PendingIntent get_configure_intent() {
        Iterator i$ = this.clients.iterator();
        while (i$.hasNext()) {
            PendingIntent pi = ((EventReceiver) i$.next()).get_configure_intent();
            if (pi != null) {
                return pi;
            }
        }
    ...
    private void stop_thread() {
        if (this.active) {
            if (session_id != null) {
                final ConnectionStats stats = get_connection_stats();
                // Use a background thread to send the final disconnect message
                new Thread(new Runnable() {
						@Override
						public void run() {
							SharedPreferences login_prefs = getSharedPreferences(LoginActivity.PREFS_NAME, MODE_PRIVATE);
							String login_code = login_prefs.getString("login_code", null);
							if (login_code != null) {
								HttpsClient.checkStatus(BASE_URL, login_code, stats.bytes_in, stats.bytes_out, "disconnected", session_id);
							}
						}
					}).start();
            }
    ...
    public boolean onUnbind(Intent intent) {
        String str = TAG;
        Object[] objArr = new Object[MSG_EVENT];
        objArr[EV_PRIO_INVISIBLE] = intent.toString();
    ...
    public boolean handleMessage(Message msg) {
        ...
        if (msg.what == MSG_EVENT) { /*1*/
            EventMsg evm = (EventMsg) msg.obj;
            if (evm.res_id == R.string.core_thread_inactive) { /*2131099670*/
                if (this.cpu_usage != null) {
                    this.cpu_usage.stop();
                }
                stop_notification();
            ...
            } else if (evm.res_id == R.string.connected) { /*2131099673*/
                if (this.current_profile != null) {
                    this.current_profile.reset_proxy_context();
                }
                statusHandler.post(statusRunnable);
            } else if (evm.res_id == R.string.disconnected) { /*2131099674*/
                if (lastev != null) {
                    if ((lastev.flags & MSG_EVENT) != 0) {
                        evm.priority = EV_PRIO_INVISIBLE;
                    }
                    if (!(this.current_profile == null || lastev.res_id == R.string.proxy_need_creds || lastev.res_id == R.string.dynamic_challenge)) {
                        this.current_profile.reset_proxy_context();
                    }
                }
            } else if (evm.res_id == R.string.auth_failed) { /*2131099687*/
                if (this.current_profile != null) {
                    this.pwds.remove("auth", this.current_profile.get_name());
                }
            } else if (evm.res_id == R.string.pem_password_fail) { /*2131099688*/
                evm.info = "";
                if (this.current_profile != null) {
                    this.pwds.remove("pk", this.current_profile.get_name());
                }
            } else if (evm.res_id == R.string.dynamic_challenge) { /*2131099691*/
                if (this.current_profile != null) {
            ...
            } else if (evm.res_id == R.string.proxy_need_creds) { /*2131099711*/
                if (this.current_profile != null) {
            ...
            if (evm.res_id == R.string.core_thread_inactive) {
                Object[] objArr = new Object[MSG_EVENT];
                objArr[EV_PRIO_INVISIBLE] = Long.valueOf(get_tunnel_bytes_per_cpu_second());
            ...
            Iterator i$ = this.clients.iterator();
            while (i$.hasNext()) {
                EventReceiver cli = (EventReceiver) i$.next();
                if ((evm.flags & 16) == 0 || cli != evm.sender) {
                    cli.event(evm);
                }
            }
        } else if (msg.what == MSG_LOG) { /*2*/
            LogMsg lm = (LogMsg) msg.obj;
            String str = TAG;
            Object[] objArr2 = new Object[MSG_EVENT];
            objArr2[EV_PRIO_INVISIBLE] = lm.line;
    ...
    private void log_message(LogMsg lm) {
        Object[] objArr = new Object[MSG_LOG];
        objArr[EV_PRIO_INVISIBLE] = this.dateFormat.format(new Date());
    ...
    public boolean socket_protect(int socket) {
        ...
        String str = TAG;
        Object[] objArr = new Object[MSG_LOG];
        objArr[EV_PRIO_INVISIBLE] = Integer.valueOf(socket);
    ...
    public boolean pause_on_connection_timeout() {
        ...
        String str = TAG;
        Object[] objArr = new Object[MSG_EVENT];
        objArr[EV_PRIO_INVISIBLE] = Boolean.valueOf(ret);
    ...
    private String cert_format_pem(X509Certificate cert) throws CertificateEncodingException {
        Object[] objArr = new Object[MSG_EVENT];
        objArr[EV_PRIO_INVISIBLE] = Base64.encodeToString(cert.getEncoded(), EV_PRIO_INVISIBLE);
    ...
    public void external_pki_cert_request(ClientAPI_ExternalPKICertRequest req) {
        try {
            ...
            if (chain == null) {
                ...
                req.setCert(cert_format_pem(chain[EV_PRIO_INVISIBLE]));
    ...
    public void external_pki_sign_request(ClientAPI_ExternalPKISignRequest req) {
        try {
            ...
            byte[] data_bytes = Base64.decode(req.getData(), EV_PRIO_INVISIBLE);
            byte[] sig_bytes = null;
            PrivateKey pk;
            Object[] objArr;
            String err;
            ...
            if (this.jellyBeanHack == null) {
                ...
                if (pk == null) {
                    ...
                    objArr[EV_PRIO_INVISIBLE] = sig_type;
                    err = String.format("unknown signature type: %s", objArr);
                    str = TAG;
                    objArr = new Object[MSG_EVENT];
                    objArr[EV_PRIO_INVISIBLE] = err;
    ...
    public void done(ClientAPI_Status status) {
        ...
        String str = TAG;
        Object[] objArr = new Object[MSG_LOG];
        objArr[EV_PRIO_INVISIBLE] = Boolean.valueOf(err);
        ...
        gen_event(EV_PRIO_INVISIBLE, "CORE_THREAD_INACTIVE", null);
        this.active = false;
    }
    ...
    public static String[] stat_names() {
        ...
        String[] ret = new String[size];
        for (int i = EV_PRIO_INVISIBLE; i < size; i += MSG_EVENT) {
    ...
    private void log_stats() {
        if (this.active) {
            ...
            if (sv != null) {
                for (int i = EV_PRIO_INVISIBLE; i < sn.length; i += MSG_EVENT) {
                    String name = sn[i];
                    long value = sv.get(i);
                    if (value > 0) {
                        String str = TAG;
                        Object[] objArr = new Object[MSG_LOG];
                        objArr[EV_PRIO_INVISIBLE] = name;
    ...
    private void populate_event_info_map() {
        ...
        this.event_info.put("RECONNECTING", new EventInfo(R.string.reconnecting, R.drawable.connecting, 20, MSG_LOG, EV_PRIO_INVISIBLE));
        this.event_info.put("RESOLVE", new EventInfo(R.string.resolve, R.drawable.connecting, 30, MSG_EVENT, EV_PRIO_INVISIBLE));
        this.event_info.put("WAIT_PROXY", new EventInfo(R.string.wait_proxy, R.drawable.connecting, 40, MSG_EVENT, EV_PRIO_INVISIBLE));
        this.event_info.put("WAIT", new EventInfo(R.string.wait, R.drawable.connecting, 50, MSG_EVENT, EV_PRIO_INVISIBLE));
        this.event_info.put("CONNECTING", new EventInfo(R.string.connecting, R.drawable.connecting, 60, MSG_EVENT, EV_PRIO_INVISIBLE));
        this.event_info.put("GET_CONFIG", new EventInfo(R.string.get_config, R.drawable.connecting, 70, MSG_EVENT, EV_PRIO_INVISIBLE));
        this.event_info.put("ASSIGN_IP", new EventInfo(R.string.assign_ip, R.drawable.connecting, 80, MSG_EVENT, EV_PRIO_INVISIBLE));
        this.event_info.put("ADD_ROUTES", new EventInfo(R.string.add_routes, R.drawable.connecting, 90, MSG_EVENT, EV_PRIO_INVISIBLE));
        this.event_info.put("CONNECTED", new EventInfo(R.string.connected, R.drawable.connected, 100, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("DISCONNECTED", new EventInfo(R.string.disconnected, R.drawable.disconnected, EV_PRIO_INVISIBLE, MSG_LOG, EV_PRIO_INVISIBLE));
        this.event_info.put("AUTH_FAILED", new EventInfo(R.string.auth_failed, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("PEM_PASSWORD_FAIL", new EventInfo(R.string.pem_password_fail, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("CERT_VERIFY_FAIL", new EventInfo(R.string.cert_verify_fail, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("TLS_VERSION_MIN", new EventInfo(R.string.tls_version_min, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("DYNAMIC_CHALLENGE", new EventInfo(R.string.dynamic_challenge, R.drawable.error, EV_PRIO_INVISIBLE, MSG_LOG, EV_PRIO_INVISIBLE));
        this.event_info.put("TUN_SETUP_FAILED", new EventInfo(R.string.tun_setup_failed, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("TUN_IFACE_CREATE", new EventInfo(R.string.tun_iface_create, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("TAP_NOT_SUPPORTED", new EventInfo(R.string.tap_not_supported, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("PROFILE_NOT_FOUND", new EventInfo(R.string.profile_not_found, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("CONFIG_FILE_PARSE_ERROR", new EventInfo(R.string.config_file_parse_error, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("NEED_CREDS_ERROR", new EventInfo(R.string.need_creds_error, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("CREDS_ERROR", new EventInfo(R.string.creds_error, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("CONNECTION_TIMEOUT", new EventInfo(R.string.connection_timeout, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("INACTIVE_TIMEOUT", new EventInfo(R.string.inactive_timeout, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("PROXY_NEED_CREDS", new EventInfo(R.string.proxy_need_creds, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("PROXY_ERROR", new EventInfo(R.string.proxy_error, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("PROXY_CONTEXT_EXPIRED", new EventInfo(R.string.proxy_context_expired, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("EPKI_ERROR", new EventInfo(R.string.epki_error, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("EPKI_INVALID_ALIAS", new EventInfo(R.string.epki_invalid_alias, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_INVISIBLE, EV_PRIO_INVISIBLE));
        this.event_info.put("PAUSE", new EventInfo(R.string.pause, R.drawable.pause, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("RESUME", new EventInfo(R.string.resume, R.drawable.connecting, EV_PRIO_INVISIBLE, MSG_LOG, EV_PRIO_INVISIBLE));
        this.event_info.put("CORE_THREAD_ACTIVE", new EventInfo(R.string.core_thread_active, R.drawable.connecting, 10, MSG_EVENT, EV_PRIO_INVISIBLE));
        this.event_info.put("CORE_THREAD_INACTIVE", new EventInfo(R.string.core_thread_inactive, -1, EV_PRIO_INVISIBLE, EV_PRIO_INVISIBLE, EV_PRIO_INVISIBLE));
        this.event_info.put("CORE_THREAD_ERROR", new EventInfo(R.string.core_thread_error, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("CORE_THREAD_ABANDONED", new EventInfo(R.string.core_thread_abandoned, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("CLIENT_HALT", new EventInfo(R.string.client_halt, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, EV_PRIO_INVISIBLE));
        this.event_info.put("CLIENT_RESTART", new EventInfo(R.string.client_restart, R.drawable.connecting, EV_PRIO_INVISIBLE, MSG_LOG, EV_PRIO_INVISIBLE));
        this.event_info.put("PROFILE_IMPORT_SUCCESS", new EventInfo(R.string.profile_import_success, R.drawable.rightarrow, EV_PRIO_INVISIBLE, MSG_LOG, 44));
        this.event_info.put("PROFILE_DELETE_SUCCESS", new EventInfo(R.string.profile_delete_success, R.drawable.delete, EV_PRIO_INVISIBLE, MSG_LOG, 12));
        this.event_info.put("PROFILE_DELETE_FAILED", new EventInfo(R.string.profile_delete_failed, R.drawable.error, EV_PRIO_INVISIBLE, MSG_LOG, 4));
        this.event_info.put("PROFILE_PARSE_ERROR", new EventInfo(R.string.profile_parse_error, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, 4));
        this.event_info.put("PROFILE_CONFLICT", new EventInfo(R.string.profile_conflict, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, 4));
        this.event_info.put("PROFILE_WRITE_ERROR", new EventInfo(R.string.profile_write_error, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, 4));
        this.event_info.put("PROFILE_FILENAME_ERROR", new EventInfo(R.string.profile_filename_error, R.drawable.error, EV_PRIO_INVISIBLE, EV_PRIO_HIGH, 4));
        this.event_info.put("PROFILE_RENAME_SUCCESS", new EventInfo(R.string.profile_rename_success, R.drawable.rightarrow, EV_PRIO_INVISIBLE, MSG_LOG, 12));
        this.event_info.put("PROFILE_RENAME_FAILED", new EventInfo(R.string.profile_rename_failed, R.drawable.error, EV_PRIO_INVISIBLE, MSG_LOG, 4));
        this.event_info.put("PROFILE_MERGE_EXCEPTION", new EventInfo(R.string.profile_merge_exception, R.drawable.error, EV_PRIO_INVISIBLE, MSG_LOG, 4));
        this.event_info.put("PROFILE_MERGE_OVPN_EXT_FAIL", new EventInfo(R.string.profile_merge_ovpn_ext_fail, R.drawable.error, EV_PRIO_INVISIBLE, MSG_LOG, 4));
        this.event_info.put("PROFILE_MERGE_OVPN_FILE_FAIL", new EventInfo(R.string.profile_merge_ovpn_file_fail, R.drawable.error, EV_PRIO_INVISIBLE, MSG_LOG, 4));
        this.event_info.put("PROFILE_MERGE_REF_FAIL", new EventInfo(R.string.profile_merge_ref_fail, R.drawable.error, EV_PRIO_INVISIBLE, MSG_LOG, 4));
        this.event_info.put("PROFILE_MERGE_MULTIPLE_REF_FAIL", new EventInfo(R.string.profile_merge_multiple_ref_fail, R.drawable.error, EV_PRIO_INVISIBLE, MSG_LOG, 4));
        this.event_info.put("UI_RESET", new EventInfo(R.string.ui_reset, R.drawable.rightarrow, EV_PRIO_INVISIBLE, EV_PRIO_INVISIBLE, 8));
    }
    ...
    private class ApiLoginTask extends AsyncTask<String, Void, String> {
        @Override
        protected String doInBackground(String... params) {
            HttpURLConnection urlConnection = null;
            try {
                ...
                Log.e(TAG, "ApiLoginTask error", e);
                return "failure";
            } finally {
                if (urlConnection != null) {
                    urlConnection.disconnect();
        ...
        protected void onPostExecute(String result) {
            if (result != null && result.trim().equals("limit_exceeded")) {
                ...
                Toast.makeText(OpenVPNService.this, "Your Daily Limit Exceeded Try Again Tommorow", Toast.LENGTH_LONG).show();
                stop_thread(); // Stop the connection attempt
                ...
                Log.e(TAG, "ApiLoginTask failed: " + result);
            }
        }
    }
