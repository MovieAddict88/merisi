...
public class ClientAPI_TunBuilderBase {
    ...
    public boolean tun_builder_add_route(String address, int prefix_length, boolean ipv6) {
        return ovpncliJNI.ClientAPI_TunBuilderBase_tun_builder_add_route(this.swigCPtr, this, address, prefix_length, ipv6);
    }

    public boolean tun_builder_exclude_route(String address, int prefix_length, boolean ipv6) {
        return ovpncliJNI.ClientAPI_TunBuilderBase_tun_builder_exclude_route(this.swigCPtr, this, address, prefix_length, ipv6);
    }
    ...
    public void tun_builder_teardown() {
        ovpncliJNI.ClientAPI_TunBuilderBase_tun_builder_teardown(this.swigCPtr, this);
    }
